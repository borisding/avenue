...
class Street extends PdoAdapter implements StreetInterface
{
    ...
    /**
     * Shortcut of finding all records, with id column, descending.
     *
     * @param array $columns
     * @param array $sorting
     */
    public function findAllDesc(array $columns = [], array $sorting = ['id DESC'])
    {
        return $this->find($columns)->orderBy($sorting)->getAll();
    }
